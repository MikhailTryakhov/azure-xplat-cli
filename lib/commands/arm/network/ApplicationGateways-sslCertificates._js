...
exports.init = function (cli) {
  ...
  sslCertificates.command('create [resource-group] [gateway-name] [name]')
    ...
    .execute(function(resourceGroup, gatewayName, name, options, _) {
      ...
      cli.interaction.formatOutput(applicationGateway.sslCertificates[generatorUtils.findIndexByKeyValue(applicationGateway.sslCertificates, 'name', name)], generatorUtils.traverse);
    });
  ...
  sslCertificates.command('set [resource-group] [gateway-name] [name]')
    ...
    .execute(function(resourceGroup, gatewayName, name, options, _) {
      ...
      cli.interaction.formatOutput(applicationGateway.sslCertificates[index], generatorUtils.traverse);
    });
