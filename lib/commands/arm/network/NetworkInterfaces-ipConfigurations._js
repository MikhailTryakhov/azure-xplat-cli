...
exports.init = function (cli) {
  ...
  ipConfigurations.command('create [resource-group] [nic-name] [name]')
    ...
    .execute(function(resourceGroup, nicName, name, options, _) {
      ...
      cli.interaction.formatOutput(networkInterface.ipConfigurations[generatorUtils.findIndexByKeyValue(networkInterface.ipConfigurations, 'name', name)], generatorUtils.traverse);
    });
  ...
  ipConfigurations.command('set [resource-group] [nic-name] [name]')
    ...
    .execute(function(resourceGroup, nicName, name, options, _) {
      ...
      cli.interaction.formatOutput(networkInterface.ipConfigurations[index], generatorUtils.traverse);
    });
