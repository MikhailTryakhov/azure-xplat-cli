...
exports.init = function (cli) {
  ...
  webApplicationFirewallConfiguration.command('create [resource-group] [gateway-name] [enable] [waf-mode] [rule-set-type] [rule-set-version]')
    ...
    .option('--gateway-name <gateway-name>', $('the gateway name'))
    .option('--enable <enable>', $('whether the web application firewall is' +
      '\n     enabled or not'))
    .option('--waf-mode <waf-mode>', $('web application firewall mode'))
    .option('--rule-set-type <rule-set-type>', $('the type of the web application' +
