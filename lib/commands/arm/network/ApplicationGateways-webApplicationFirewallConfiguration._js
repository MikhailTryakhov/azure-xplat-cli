...
exports.init = function (cli) {
  ...
  webApplicationFirewallConfiguration.command('create [resource-group] [gateway-name]')
    ...
    .option('-e, --enable [enable]', $('whether the web application firewall is' +
      '\n     enabled or not'))
    .option('-m, --waf-mode [waf-mode]', $('web application firewall mode. Possible' +
      '\n     values are: \'Detection\' and \'Prevention\''))
    ...
    .execute(function(resourceGroup, gatewayName, options, _) {
      ...
      result.webApplicationFirewallConfiguration = parameters.webApplicationFirewallConfiguration;
      ...
      cli.interaction.formatOutput(result.webApplicationFirewallConfiguration, generatorUtils.traverse);
    });
  ...
  webApplicationFirewallConfiguration.command('show [resource-group] [gateway-name]')
    ...
    .execute(function(resourceGroup, gatewayName, options, _) {
      ...
      var childResult = result.webApplicationFirewallConfiguration;
      if(!childResult) {
        cli.output.warn(util.format($('web application firewall configuration not found in the "%s"'), result.name));
      }
  ...
  webApplicationFirewallConfiguration.command('list [resource-group] [gateway-name]')
    ...
    .execute(function(resourceGroup, gatewayName, options, _) {
      ...
      var items = result.webApplicationFirewallConfiguration;
