...
exports.init = function (cli) {
  ...
  frontendIPConfigurations.command('create [resource-group] [gateway-name] [name]')
    ...
    .execute(function(resourceGroup, gatewayName, name, options, _) {
      ...
      cli.interaction.formatOutput(applicationGateway.frontendIPConfigurations[generatorUtils.findIndexByKeyValue(applicationGateway.frontendIPConfigurations, 'name', name)], generatorUtils.traverse);
    });
  ...
  frontendIPConfigurations.command('set [resource-group] [gateway-name] [name]')
    ...
    .execute(function(resourceGroup, gatewayName, name, options, _) {
      ...
      cli.interaction.formatOutput(applicationGateway.frontendIPConfigurations[index], generatorUtils.traverse);
    });
