...
exports.init = function (cli) {
  ...
  httpListeners.command('create [resource-group] [gateway-name] [name]')
    ...
    .execute(function(resourceGroup, gatewayName, name, options, _) {
      ...
      cli.interaction.formatOutput(applicationGateway.httpListeners[generatorUtils.findIndexByKeyValue(applicationGateway.httpListeners, 'name', name)], generatorUtils.traverse);
    });
  ...
  httpListeners.command('set [resource-group] [gateway-name] [name]')
    ...
    .execute(function(resourceGroup, gatewayName, name, options, _) {
      ...
      cli.interaction.formatOutput(applicationGateway.httpListeners[index], generatorUtils.traverse);
    });
