...
exports.init = function (cli) {
  ...
  backendHealth.command('show [resource-group] [gateway-name]')
    ...
    .execute(function(resourceGroup, gatewayName, options, _) {
      ...
      try {
        result = networkManagementClient.applicationGateways.backendHealth(resourceGroup, gatewayName, _);
      } finally {
        progress.end();
      }
  ...
  applicationGateways.command('delete [resource-group] [name]')
    ...
    .execute(function(resourceGroup, name, options, _) {
      ...
      try {
        result = networkManagementClient.applicationGateways.get(resourceGroup, name, null, _);
      } catch (e) {
        if (e.statusCode === 404) {
          result = null;
        } else {
      ...
      try {
        if(options.nowait) {
          networkManagementClient.applicationGateways.beginDeleteMethod(resourceGroup, name, options, _);
        } else {
          networkManagementClient.applicationGateways.deleteMethod(resourceGroup, name, options, _);
        }
    ...
    .execute(function(resourceGroup, options, _) {
      ...
      try {
        if(typeof networkManagementClient.applicationGateways.listAll != 'function') {
          ...
          result = networkManagementClient.applicationGateways.list(resourceGroup,  _);
        } else {
          if(options.resourceGroup) {
            ...
            progress = cli.interaction.progress($('Getting the application gateways'));
            result = networkManagementClient.applicationGateways.listAll(_);
          }
        }
      } finally {
        progress.end();
  ...
  applicationGateways.command('start [resource-group] [name]')
    ...
    .execute(function(resourceGroup, name, options, _) {
      ...
      try {
        result = networkManagementClient.applicationGateways.start(resourceGroup, name, _);
      } finally {
        progress.end();
      }
      cli.interaction.formatOutput(result, generatorUtils.traverse);
  ...
  applicationGateways.command('stop [resource-group] [name]')
    ...
    .execute(function(resourceGroup, name, options, _) {
      ...
      try {
        result = networkManagementClient.applicationGateways.stop(resourceGroup, name, _);
      } finally {
        progress.end();
      }
      cli.interaction.formatOutput(result, generatorUtils.traverse);
