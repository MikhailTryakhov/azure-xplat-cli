...
exports.init = function (cli) {
  ...
  probes.command('create [resource-group] [gateway-name] [name] [host-name] [path] [timeout]')
    .description($('Create a probes'))
    .usage('[options] <resource-group> <gateway-name> <name> <host-name> <path> <timeout>')
    ...
    .execute(function(resourceGroup, gatewayName, name, hostName, path, timeout, options, _) {
      resourceGroup = cli.interaction.promptIfNotGiven($('resource group : '), resourceGroup, _);
      gatewayName = cli.interaction.promptIfNotGiven($('gateway name : '), gatewayName, _);
      name = cli.interaction.promptIfNotGiven($('name : '), name, _);
      options.hostName = cli.interaction.promptIfNotGiven($('host name : '), hostName, _);
      ...
      cli.interaction.formatOutput(applicationGateway.probes[generatorUtils.findIndexByKeyValue(applicationGateway.probes, 'name', name)], generatorUtils.traverse);
    });
  ...
  probes.command('set [resource-group] [gateway-name] [name]')
    ...
    .execute(function(resourceGroup, gatewayName, name, options, _) {
      ...
      cli.interaction.formatOutput(applicationGateway.probes[index], generatorUtils.traverse);
    });
