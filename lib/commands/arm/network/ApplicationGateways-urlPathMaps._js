...
exports.init = function (cli) {
  ...
  urlPathMaps.command('create [resource-group] [gateway-name] [name]')
    ...
    .execute(function(resourceGroup, gatewayName, name, options, _) {
      ...
      cli.interaction.formatOutput(applicationGateway.urlPathMaps[generatorUtils.findIndexByKeyValue(applicationGateway.urlPathMaps, 'name', name)], generatorUtils.traverse);
    });
