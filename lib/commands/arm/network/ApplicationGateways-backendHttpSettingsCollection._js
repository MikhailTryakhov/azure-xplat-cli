...
exports.init = function (cli) {
  ...
  backendHttpSettingsCollection.command('create [resource-group] [gateway-name] [name] [port]')
    ...
    .execute(function(resourceGroup, gatewayName, name, port, options, _) {
      ...
      if(utils.findFirstCaseIgnore(result.backendHttpSettingsCollection, {name: name})) {
      ...
      result.backendHttpSettingsCollection.push(parameters.backendHttpSettingsCollection[index]);
  ...
  backendHttpSettingsCollection.command('set [resource-group] [gateway-name] [name]')
    ...
    .execute(function(resourceGroup, gatewayName, name, options, _) {
      ...
      var childResult = utils.findFirstCaseIgnore(result.backendHttpSettingsCollection, {name: name});
      var index = utils.indexOfCaseIgnore(result.backendHttpSettingsCollection, {name: name});
      if(!childResult) {
  ...
  backendHttpSettingsCollection.command('delete [resource-group] [gateway-name] [name]')
    ...
    .execute(function(resourceGroup, gatewayName, name, options, _) {
      ...
      var index = utils.indexOfCaseIgnore(result.backendHttpSettingsCollection, {name: name});
      if (index === -1) {
        throw new Error(util.format($('backend http settings collection "%s" not found in the gatewayName "%s"'), name, result.name));
      }
      ...
      result.backendHttpSettingsCollection.splice(index, 1);
  ...
  backendHttpSettingsCollection.command('show [resource-group] [gateway-name] [name]')
    ...
    .execute(function(resourceGroup, gatewayName, name, options, _) {
      ...
      var childResult = utils.findFirstCaseIgnore(result.backendHttpSettingsCollection, {name: name});
      if(!childResult) {
        cli.output.warn(util.format($('backend http settings collection with name "%s" not found in the gatewayName "%s"'), name, result.name));
      }
  ...
  backendHttpSettingsCollection.command('list [resource-group] [gateway-name]')
    ...
    .execute(function(resourceGroup, gatewayName, options, _) {
      ...
      var items = result.backendHttpSettingsCollection;
