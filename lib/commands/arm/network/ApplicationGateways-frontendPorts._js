...
exports.init = function (cli) {
  ...
  frontendPorts.command('create [resource-group] [gateway-name] [name]')
    ...
    .execute(function(resourceGroup, gatewayName, name, options, _) {
      ...
      cli.interaction.formatOutput(applicationGateway.frontendPorts[generatorUtils.findIndexByKeyValue(applicationGateway.frontendPorts, 'name', name)], generatorUtils.traverse);
    });
  ...
  frontendPorts.command('set [resource-group] [gateway-name] [name]')
    ...
    .execute(function(resourceGroup, gatewayName, name, options, _) {
      ...
      cli.interaction.formatOutput(applicationGateway.frontendPorts[index], generatorUtils.traverse);
    });
