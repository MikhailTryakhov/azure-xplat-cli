...
exports.init = function (cli) {
  ...
  requestRoutingRules.command('create [resource-group] [gateway-name] [name]')
    ...
    .execute(function(resourceGroup, gatewayName, name, options, _) {
      ...
      if(options.httpSettingsId) {
        ...
        var referredbackendHttpSettings = utils.findFirstCaseIgnore(applicationGateway.backendHttpSettingsCollection, {name: options.backendHttpSettingsName});
      ...
      cli.interaction.formatOutput(applicationGateway.requestRoutingRules[generatorUtils.findIndexByKeyValue(applicationGateway.requestRoutingRules, 'name', name)], generatorUtils.traverse);
    });
  ...
  requestRoutingRules.command('set [resource-group] [gateway-name] [name]')
    ...
    .execute(function(resourceGroup, gatewayName, name, options, _) {
      ...
      cli.interaction.formatOutput(applicationGateway.requestRoutingRules[index], generatorUtils.traverse);
    });
